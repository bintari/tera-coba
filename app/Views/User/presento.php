        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-10 d-flex align-items-center">
                    <h1 class="logo mr-auto"><a href="index.html">TERA / TERA ULANG</a></h1>
                    ...
                    <nav class="nav-menu d-none d-lg-block">
                        <ul>
                            ...
                            <li><a href="#about">Alur Tera / Tera Ulang</a></li>
                            
                            <li><a href="#contact">Kontak</a></li>
                        </ul>
                    </nav><!-- .nav-menu -->

                    <a href="<?= base_url('user/login') ?>" class="get-started-btn scrollto">Masuk</a>
                </div>
            </div>
